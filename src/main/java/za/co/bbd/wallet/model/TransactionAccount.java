...
public class TransactionAccount {
    @ApiModelProperty(name = "transaction-account-id", required = true, example = "3b385ef0-d76c-4f0f-add8-b4ecf41874d6",
            notes = "The unique id of the transaction-account")
    @JsonProperty(value = "transaction-account-id", required = true)
    @NotNull
    private UUID Id;
